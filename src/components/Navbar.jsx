...
import AdminLoginModal from "../pages/AdminPanel";
      ...
      <nav className="bg-black shadow-md fixed top-0 w-full z-50">
        <div className="max-w-6xl mx-auto px-4 py-3 flex justify-between items-center">
          ...
          <ul className={`md:flex space-x-6 ${open ? "block" : "hidden"} md:block`}>
            ...
            <li>
              <a href="#about" className="hover:text-white text-green-600">
                {traducciones.about}
              </a>
            </li>
            <li>
              <a href="#skills" className="hover:text-white text-green-600">
                {traducciones.skills}
              </a>
            </li>
            <li>
              <a href="#projects" className="hover:text-white text-green-600">
                {traducciones.projects}
              </a>
            </li>
            <li>
              <a href="#contact" className="hover:text-white text-green-600">
                {traducciones.contact}
              </a>
            </li>
            <li>
              <button
